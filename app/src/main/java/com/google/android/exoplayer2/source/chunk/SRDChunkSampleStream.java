 ...
 */
public class SRDChunkSampleStream<T extends ChunkSource> implements SampleStream, SequenceableLoader,
    ...
    private final SequenceableLoader.Callback<SRDChunkSampleStream<T>> callback;
    ...
    public final class EmbeddedSampleStream implements SampleStream {
        ...
        public final SRDChunkSampleStream<T> parent;

        private final DefaultTrackOutput sampleQueue;
        private final int index;

        public EmbeddedSampleStream(SRDChunkSampleStream<T> parent, DefaultTrackOutput sampleQueue,
                                    int index) {
            this.parent = parent;
