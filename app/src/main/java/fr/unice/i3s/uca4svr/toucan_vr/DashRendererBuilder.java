...
public class DashRendererBuilder implements RendererBuilder {
  ...
  private static final int AUDIO_BUFFER_SEGMENTS = 54;  //default value
  private static final int TEXT_BUFFER_SEGMENTS = 2;    //default value
  private static final int LIVE_EDGE_LATENCY_MS = 30000; /*for live streams, number of ms that the playback should lag behind the "live edge"
  ...
  public DashRendererBuilder(Context context, String userAgent, String url,
    ...
    this.bufferSegmentSize = 64 * 1024;     //using default value
    this.videoBufferSegments = 200;         //using default value
  }
  public DashRendererBuilder(Context context, String userAgent, String url,
                             MediaDrmCallback drmCallback, int bufferSegmentSize, int bufferSegmentCount) {
    this.context = context;
    this.userAgent = userAgent;
    this.url = url;
    this.drmCallback = drmCallback;
    this.bufferSegmentSize = bufferSegmentSize;
    this.videoBufferSegments = bufferSegmentCount;
  }

  @Override
  public void buildRenderers(MyExoPlayer player) {    //called from MyExoPlayer prepare
    currentAsyncBuilder = new AsyncRendererBuilder(context, userAgent, url, drmCallback, player, bufferSegmentSize, videoBufferSegments);
  ...
  private static final class AsyncRendererBuilder
    ...
    public AsyncRendererBuilder(Context context, String userAgent, String url,
                                MediaDrmCallback drmCallback, MyExoPlayer player, int bufferSegmentSize,
    ...
    private void buildRenderers() {
      ...
      LoadControl loadControl = new DefaultLoadControl(new DefaultAllocator(bufferSegmentSize));
      ...
      ChunkSource videoChunkSource = new DashChunkSource(manifestFetcher,
              ...
              new AdaptiveEvaluator(bandwidthMeter), LIVE_EDGE_LATENCY_MS, 0, null,
              null, MyExoPlayer.TYPE_VIDEO);
      ChunkSampleSource videoSampleSource = new ChunkSampleSource(videoChunkSource, loadControl,
              videoBufferSegments * bufferSegmentSize);
      final MediaCodecVideoTrackRenderer videoRenderer = new MediaCodecVideoTrackRenderer(context,
      ...
      ChunkSource audioChunkSource = new DashChunkSource(manifestFetcher,
              ...
              0, null, null, MyExoPlayer.TYPE_AUDIO);
      ChunkSampleSource audioSampleSource = new ChunkSampleSource(audioChunkSource,
              loadControl, AUDIO_BUFFER_SEGMENTS * bufferSegmentSize);
      ...
      ChunkSource textChunkSource = new DashChunkSource(manifestFetcher,
          ...
          elapsedRealtimeOffset, mainHandler, player, MyExoPlayer.TYPE_TEXT);
      ChunkSampleSource textSampleSource = new ChunkSampleSource(textChunkSource, loadControl,
          TEXT_BUFFER_SEGMENTS * bufferSegmentSize, mainHandler, player,
              MyExoPlayer.TYPE_TEXT);
      TrackRenderer textRenderer = new TextTrackRenderer(textSampleSource, player,
          mainHandler.getLooper());

      // Invoke the callback onRenderers to tell that the renderers are ready
      ...
      renderers[MyExoPlayer.TYPE_TEXT] = textRenderer;
