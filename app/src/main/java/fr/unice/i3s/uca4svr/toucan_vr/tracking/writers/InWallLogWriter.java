 ...
 *
 * @author Lucile Sassatelli
 */

public class InWallLogWriter extends LogWriter {
  ...
  public InWallLogWriter(String logFilePrefix) {
    super(logFilePrefix, "fr.unice.i3s.uca4svr.tracking.writers.InWallLogWriter"
      + loggerNextID++);
  }
  /**
  ...
  protected String createLogFileName(String logFilePrefix) {
    ...
    Date date = new Date();
    return String.format("%s_inWall_%s.csv", logFilePrefix, dateFormat.format(date));
  }
