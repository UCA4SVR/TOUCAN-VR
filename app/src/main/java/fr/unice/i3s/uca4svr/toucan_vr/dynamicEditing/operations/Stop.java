...
public class Stop extends DynamicOperation {
  ...
  @Override
  public void activate(final GVRVideoSceneObjectPlayer<ExoPlayer> player, GVRSceneObject videoHolder, HeadMotionTracker headMotionTracker, DynamicOperationsTracker tracker) {
